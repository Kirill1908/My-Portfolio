# Personal Portfolio & Web Developer Showcase 🚀

A modern, high-performance portfolio website built to showcase my technical skills, creative projects, and web development journey. The site is designed with a focus on clean UI, smooth user experience, and robust technical implementation.

## 🌐 Live Demo
[https://hasan-dev-portfolio.vercel.app](https://hasan-dev-portfolio.vercel.app)
...
* **Animations:** [Framer Motion](https://www.framer.com/motion/) for interactive UI/UX components
* **Forms:** Integration with [Web3Forms](https://web3forms.com/) for serverless communication
